...
public class OperacionesAlumno extends Operaciones<Alumno>{
	...
	public void eliminaPorNoEconomico(List<Alumno> lista,String noEco){//metodo para eliminar alumno por numero economico 
		Iterator<Alumno> iterador = lista.iterator();
	...
	public Alumno buscarNoEconomico(List<Alumno> lista,String noEco){
		Alumno elemento = null;
		Iterator<Alumno> iterador = lista.iterator();
